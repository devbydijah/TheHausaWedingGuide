 ...
 */
export default function VendorTracker({ data, addVendor, updateVendor, deleteVendor, setActiveSection }) {
  return (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-blue-500 to-cyan-500 rounded-xl p-8 text-white text-center">
        <div className="text-6xl mb-4">🏪</div>
        <h1 className="font-playfair text-3xl font-bold mb-3">Vendor Tracker</h1>
        <p className="font-inter text-lg opacity-90">Manage your wedding service providers</p>
      </div>
