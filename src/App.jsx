...
// --- USE THE PROVIDED TEST LINKS ---
const PDF_GUIDE_STOREFRONT_URL =
  "https://paystack.com/buy/northern-wedding-guide-by-hausaroom-vzdojl"; // PDF Test Link
const WEB_APP_STOREFRONT_URL =
...
function App() {
  ...
  const [purchasedProductType, setPurchasedProductType] = useState(null); // 'pdf' or 'webapp'
  ...
  useEffect(() => {
    ...
    if (guideParam === "1") {
      setShowGuide(true);
      if (emailParam) {
        setUserEmail(emailParam); // Pre-fill email for signup
      }
    } else if (purchasedParam) {
      setPurchasedProductType(purchasedParam); // 'pdf' or 'webapp'
  ...
  const handleLogout = async () => {
    // Supabase handles session clearing
    setShowGuide(false);
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <strong>PDF Guide</strong> for offline planning or the dynamic{" "}
            <strong>Interactive Web Planner</strong> for a modern, guided
            experience. Both ensure an authentic celebration.
          </p>
          <div
      ...
      <section id="pricing" className="py-16 md:py-24 bg-[#F9F4F1]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-fade-in">
            <h2 className="font-playfair text-3xl md:text-4xl lg:text-5xl font-bold text-[#740015] mb-4">
              Invest in Your Perfect Wedding
            </h2>
            <p className="text-gray-600 text-base md:text-lg max-w-2xl mx-auto">
              Simple, one-time payments for invaluable planning tools. (Test
              prices shown).
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="bg-white rounded-2xl p-8 border-2 border-[#CE805C]/50 shadow-lg text-center flex flex-col items-center animate-slide-up">
              <DownloadSimpleIcon
                size={48}
                weight="duotone"
                className="text-[#CE805C] mb-4"
              />
              <h3 className="font-playfair text-2xl font-bold text-[#740015] mb-2">
                PDF Wedding Guide
              </h3>
              <p className="text-gray-600 text-sm mb-6">
                Comprehensive & Printable
              </p>
              <p className="font-playfair text-5xl font-bold text-[#740015] mb-2">
                ₦100
              </p>
              <p className="text-gray-500 text-sm mb-8">One-time payment</p>
              <ul className="space-y-3 text-sm text-gray-700 text-left mb-8 list-none pl-0">
                <li className="flex items-center gap-2">
                  <CheckCircleIcon
                    size={18}
                    weight="fill"
              ...
              <button
                onClick={handlePurchasePDF}
                className="w-full mt-auto px-8 py-3 bg-[#CE805C] hover:bg-[#B87050] text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-300"
              >
                Buy PDF Guide (Test)
              </button>
            </div>
            <div
              className="bg-gradient-to-br from-[#740015] to-[#531946] rounded-2xl p-8 border-2 border-transparent shadow-2xl text-center flex flex-col items-center animate-slide-up"
              style={{ animationDelay: "0.2s" }}
            >
              <MonitorPlayIcon
                size={48}
              ...
              <p className="font-playfair text-5xl font-bold text-[#D4A574] mb-2">
                ₦100
              </p>
              <p className="text-white/70 text-sm mb-8">One-time payment</p>
              <ul className="space-y-3 text-sm text-white/90 text-left mb-8 list-none pl-0">
                <li className="flex items-center gap-2">
                  <CheckCircleIcon
                    size={18}
                    weight="fill"
              ...
              <button
                onClick={handlePurchaseWebApp}
                className="w-full mt-auto px-8 py-3 bg-[#D4A574] hover:bg-[#CE805C] text-[#740015] font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-300"
              >
                Buy Interactive Guide (Test)
              </button>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full mx-auto overflow-hidden animate-slide-up">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="bg-[#CE805C]/10 border-l-4 border-[#CE805C] rounded-r-lg p-4">
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  Please check your inbox (and spam folder!) for an email
                  containing your access details.
                  {purchasedProductType === "pdf" &&
                    " It includes your unique download link (valid for 24 hours)."}
                  {purchasedProductType === "webapp" &&
                    " It includes a link to create your account for the interactive planner."}
                </p>
              </div>
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <ol className="space-y-1 text-sm text-gray-600 list-decimal list-inside">
                  ...
                  {purchasedProductType === "pdf" && (
                    <li>Click the download link & save your PDF.</li>
                  )}
                  {purchasedProductType === "webapp" && (
                    <li>Click the signup link & create your account.</li>
                  )}
