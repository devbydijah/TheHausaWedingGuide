...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (productType === 'webapp') {
      ...
      const testDownloadLink = 'https://the-hausa-weding-guide.vercel.app?download=test';
      ...
      const testDownloadLink = 'https://the-hausa-weding-guide.vercel.app?download=test';
      result = await sendBundleEmail(testEmail, testDownloadLink, 'TEST-REF-123', false);
