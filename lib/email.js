...
export async function sendDownloadEmail(email, downloadLink, productType = 'pdf') {
  try {
    // Different email content based on product type
    const productConfig = {
      pdf: {
        title: "Your Hausa Wedding Guide – Download Link",
        productName: "Hausa Wedding Guide PDF",
        buttonText: "Download Your Guide",
        description: "Click the button below to download your Hausa Wedding Guide. This link is secure and temporary.",
        instructions: [
          "This link expires in 24 hours.",
          "We do not resend download links by email.",
          "Please use the same email you used at checkout to claim access on our site.",
          "Save a copy of the PDF after download for your records."
        ]
      },
      webapp: {
        title: "Your Interactive Wedding Guide – Access Link",
        productName: "Interactive Wedding Guide",
        buttonText: "Start Your Interactive Guide",
        description: "Click the button below to access your interactive wedding planning guide. This link is secure and temporary.",
        instructions: [
          "This link expires in 24 hours.",
          "We do not resend access links by email.",
          "Please use the same email you used at checkout to claim access on our site.",
          "Bookmark the guide for easy access during your planning."
        ]
      }
    };

    const config = productConfig[productType] || productConfig.pdf;
    const { data, error } = await resend.emails.send({
        ...
        <div style="font-family: Inter, -apple-system, Segoe UI, Roboto, Arial, sans-serif; background:#faf7f6; margin:0; padding:24px;">
          <div style="max-width:640px; margin:0 auto; background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 6px 24px rgba(0,0,0,0.06)">
            ...
            <div style="background: linear-gradient(135deg,#990200,#531946); padding:20px 24px; color:#fff;">
              <div style="font-size:18px; font-weight:700; letter-spacing:.2px;">${config.productName}</div>
      ...
      `,
      text: `${config.productName} is ready.
